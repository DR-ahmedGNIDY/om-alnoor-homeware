      ...
      <div className="min-h-screen bg-black pt-32 pb-20">
        <div className="container-luxury">
          <div className="text-center py-20">
            ...
            <h1 className="text-3xl font-bold text-cream mb-4">سلة التسوق فارغة</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        <div className="text-right">
                          ...
                          {item.product.discountPrice && (
                            <p className="text-xs text-green-400">
                              وفري {formatPrice(itemOriginalTotal - itemTotal)}
                            </p>
                          )}
                        </div>
                      </div>
          ...
          <div className="lg:col-span-1">
            <div className="luxury-card p-6 sticky top-32">
              <h2 className="text-xl font-bold text-cream mb-6">ملخص الطلب</h2>

              <div className="space-y-4 mb-6">
                <div className="flex justify-between text-sm">
                  <span className="text-gold-muted">المجموع الفرعي</span>
                  <span className="text-cream">{formatPrice(discountedTotal)}</span>
                </div>
                <div className="flex justify-between text-sm">
              ...
              <Link
                href="/checkout"
                className="w-full btn-gold py-4 flex items-center justify-center gap-2 text-base"
              >
